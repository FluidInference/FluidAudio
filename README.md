...
- **Automatic Speech Recognition (ASR)**: [Batch transcription](Documentation/Models.md#batch-transcription-near-real-time) with TDT and CTC models supporting 25 European languages, Japanese, and Chinese; [Parakeet EOU](Documentation/Models.md#streaming-transcription-true-real-time) (120m) for streaming ASR with end-of-utterance detection (English only). See all [ASR models](Documentation/Models.md#asr-models).
