...
The Kokoro TTS stack is packaged with an `ESpeakNG.xcframework` that supports both Apple Silicon (arm64) and Intel (x86_64) architectures, enabling compatibility with macOS devices of both types.
