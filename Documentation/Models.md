...
| **Magpie TTS Multilingual** | NVIDIA Magpie multilingual TTS (357M params). Managed by `MagpieTtsManager`. | **Experimental** — below real-time on Apple Silicon (agg-RTFx ≈ 0.4× on M2); prefer Kokoro ANE or PocketTTS for production. |
