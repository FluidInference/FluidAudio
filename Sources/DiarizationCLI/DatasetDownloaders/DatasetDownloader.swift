...
public struct DatasetDownloader {

// MARK: - AMI Dataset Download

public static func downloadAMIDataset(
        ...
        do {
            ...
            if let httpResponse = response as? HTTPURLResponse {
                if httpResponse.statusCode == 200 {
                    ...
                    if await AudioProcessing.isValidAudioFile(outputPath) {
...
// MARK: - VAD Dataset Download

/// Download VAD dataset from Hugging Face
public static func downloadVadDataset(force: Bool, dataset: String = "mini50") async {
