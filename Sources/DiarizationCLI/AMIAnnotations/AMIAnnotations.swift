    ...
    // MARK: - AMI Annotation Models

    /// Represents a single AMI speaker segment from NXT format
    public struct AMISpeakerSegment {
    ...
    public struct AMISpeakerMapping {
    ...
    public class AMIAnnotationParser: NSObject {

        /// Parse segments.xml file and return speaker segments
        public func parseSegmentsFile(_ xmlFile: URL) throws -> [AMISpeakerSegment] {
        ...
        public func parseSpeakerMapping(for meetingId: String, from meetingsFile: URL) throws
            -> AMISpeakerMapping?
        {
    ...
    // MARK: - AMI Ground Truth Utilities

    public struct AMIGroundTruthLoader {

        /// Get ground truth speaker count from AMI meetings.xml
        public static func getGroundTruthSpeakerCount(for meetingId: String) -> Int {
        ...
        public static func loadAMIGroundTruth(for meetingId: String, duration: Float) async
            -> [TimedSpeakerSegment]
        {
            ...
            do {
                ...
                for speakerCode in ["A", "B", "C", "D"] {
                    ...
                    if FileManager.default.fileExists(atPath: segmentFile.path) {
                        ...
                        guard let participantId = speakerMapping.participantId(for: speakerCode)
                        else {
                            continue
                        }
        ...
        public static func generateSimplifiedGroundTruth(duration: Float, speakerCount: Int)
            -> [TimedSpeakerSegment]
        {
        ...
        private static func generatePlaceholderEmbedding(for participantId: String) -> [Float] {
