...
public actor PerformanceMonitor {
    ...
    public init() {}
    private let logger = AppLogger(subsystem: "com.fluidinference.asr", category: "Performance")
    private var metrics: [ASRPerformanceMetrics] = []
    private let signpostLogger = OSSignposter(subsystem: "com.fluidinference.asr", category: "Performance")
