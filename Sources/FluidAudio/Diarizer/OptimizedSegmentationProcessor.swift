...
/// Optimized segmentation processor with ANE-aligned memory and zero-copy operations
@available(macOS 13.0, iOS 16.0, *)
public struct OptimizedSegmentationProcessor {

    private let logger = Logger(subsystem: "com.fluidinfluence.diarizer", category: "OptimizedSegmentation")
