...
public struct VadConfig: Sendable {
    ...
    public var computeUnits: MLComputeUnits = EnvUtils.preferredComputeUnits()  // Preferred compute units
    ...
    /// Platform-optimized configuration for iOS devices
        ...
        public static let iosOptimized = VadConfig(
            ...
            minThreshold: 0.1,
            maxThreshold: 0.7,
            computeUnits: EnvUtils.preferredComputeUnits(),  // Prefer Neural Engine on iOS
...
public actor VadManager {
    ...
    private func downloadMissingVadModels() async throws {
        ...
        for folderName in modelFolders {
            ...
            if !FileManager.default.fileExists(atPath: folderPath.path) {
                ...
                try await DownloadUtils.downloadVadModelFolder(
    ...
    private func getModelsDirectory() -> URL {
        let directory = EnvUtils.modelsDirectory(for: "vad")
